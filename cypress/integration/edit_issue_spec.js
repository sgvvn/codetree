...
describe('Codetree : Edit issue functionality Tests', () => {
    ...
    it('verify fields at edit issue window', () => {
    ...
    it.skip('verify popup message by put blank issue title EDISSU_004', () => {
    ...
    it.skip('verify editing issue functionality for updating title to cancle button EDISSU_003', () => {
        cy.get('div[data-id="backlog"] h3.board-card-title').contains(random).click();
        cy.get('span.issue-form-title').should('contain',random);
    ...
    it('verify editing issue to checking functionality for updating Description', () => {
        cy.get('div[data-id="backlog"] h3.board-card-title').contains(random).click();
        cy.get('span.issue-form-title').should('contain',random);
